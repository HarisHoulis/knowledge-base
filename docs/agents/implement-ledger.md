...
| 263 | 2026-09-11 | ✓ Preflight | ✓ seam | ✓ bounds | 4 asm | 1 esc | out-of-bounds ×2, assertion-shape ×1, trade-off-awareness ×1, duplicated-code ×2, data-clumps ×1, mysterious-name ×1, speculative-generality ×1, structural-decay ×1, scope-creep ×1, requirement-drift ×1, bypassed-seam ×1, unstated-decision ×1, tautological-test ×1, dead-branch ×1 | 11 minor / 2 major / 2 blocker | spec-gap ×7, unstated-decision ×4, bounding-box-gap ×2, seam-gap ×2 | [#268](https://github.com/HarisHoulis/knowledge-base/pull/268) |
| 302 | 2026-09-12 | ✓ Preflight | ✓ seam | ✓ bounds | 3 asm | 0 esc | duplicated-code ×2, divergent-change ×1, doc-standard ×2, message-chains ×1, requirement-partial ×2, scope-creep ×1 | 9 minor / 0 major / 0 blocker | seam-gap ×2, unstated-decision ×3, spec-gap ×3, bounding-box-gap ×1 | pending |
